...
, CONSTRAINT CUSTOMERS_PK PRIMARY KEY (CUSTOMER_ID, ADDRESS_ID)
...
(
  ...
  PARTS_ID NUMBER,
  ORDER_ID NUMBER,
  CONSTRAINT FK_PARTS_ID FOREIGN KEY (PARTS_ID) REFERENCES PARTS(PART_ID),
...
(
  ...
  CONSTRAINT REP_CUST_FK1 FOREIGN KEY (CUSTOMER_ID, ADDRESS_ID) REFERENCES CUSTOMERS(CUSTOMER_ID, ADDRESS_ID) ON DELETE CASCADE,
  CONSTRAINT REP_PARTS_FK3 FOREIGN KEY (REPAIR_ID) REFERENCES PARTS_IN_REPAIR(PIR_ID) ON DELETE CASCADE,
  CONSTRAINT REP_STATUS_FK4 FOREIGN KEY (STATUS_ID) REFERENCES STATUS(STATUS_ID) ON DELETE CASCADE,
  CONSTRAINT REP_TECHN_FK2 FOREIGN KEY (TECHNICIAN_ID) REFERENCES TECHNICIANS(TECHNICIAN_ID) ON DELETE CASCADE
);
...
(
  ...
  CONSTRAINT TECH_DEPT_FK FOREIGN KEY (DEPARTMENT_ID) REFERENCES DEPARTMENTS(DEPARTMENT_ID)
);
