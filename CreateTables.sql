...
ADD CONSTRAINT PIO_ORDERS_FK1 FOREIGN KEY(ORDER_ID)REFERENCES ORDERS(ORDER_ID)ON DELETE CASCADE ENABLE;

ALTER TABLE PARTS_IN_ORDER
ADD CONSTRAINT PIO_PARTS_FK2 FOREIGN KEY(PIO_ID)REFERENCES PARTS(PART_ID );
--
